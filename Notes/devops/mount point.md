On [[linux]] systems you do not have drive letters (like C:/ on windows). Instead, everything gets attached at some directory ([[the mount point). So any path underneath it is served from there. 
